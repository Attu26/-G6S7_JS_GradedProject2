...
// It will  check buttons to display based on current resume index and allResumes(filtered out on the basis of search input)
...
// Will enter the data in all the html placeholders based on currently selected resume
const fillData = () => {
...
// it will check the length of filtered out resumes based on search input and makes a decision which container to show, no results or resume
const checkResumes = () => {
